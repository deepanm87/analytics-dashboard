...
export default function VisitorFilter({ visitorFiltersPromise }: {
    ...
    const [optimisticFilters, setOptimisticFilters] = useOptimistic(selectedFilters)
    ...
    return (
        <div data-pending={isPending ? "true" : undefined}>
            <ToggleGroup 
                toggleKey="filter"
                options={options}
                selectedValues={optimisticFilters}
                onToggle={ newFilters => {
